...
class VideoData(object):
    ...
    def __getitem__(self, index):
        ...
        # feature = torch.tensor(video['feature'][()]).t() ['features'][...]
        feature = torch.tensor(video['features'][...])
        user_summary = torch.tensor(video['user_summary'][...])
        positions = torch.tensor(video['picks'][...])
        # user_summary = dataset[key]['user_summary'][...]
        key = 'video_' + str(index)
        return feature, user_summary, positions, key, index
